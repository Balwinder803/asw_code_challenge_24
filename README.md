...
- Get the full-scale configuration - Done
- Get and set the output data rate - Done
- Enable or disable the interrupt pin - Done
- Read the output data of a specified axis -Done
